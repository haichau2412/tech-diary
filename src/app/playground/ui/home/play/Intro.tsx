  ...
  return (
    <article className="px-8">
      <div className="flex flex-col items-center border-4 border-green-950 bg-green-200 pb-10">
        <h1 className="absolute left-1/2 w-fit -translate-x-1/2 -translate-y-1/2 rounded-xs bg-green-950 px-3 py-2 text-3xl font-extrabold text-white uppercase md:text-6xl">
          Playground!
        </h1>
        <AutoCarousel />
